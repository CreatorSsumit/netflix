...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-modal="true" role="dialog">
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input value={state.email ? state.email : ''} name='email' onChange={(e)=>handelchanges(e)}  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane@netlink.com" />
 {state.email?state.email.indexOf('netlink.com') > -1 ? '' :<small style={{color:'red'}}>Should be Netlinker</small> :''}
    </div>
    <div class="w-full md:w-1/2 px-3">
      <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
        Phone no 
      </label>
      <input value={state.phoneno ? state.phoneno : ''} name='phoneno'  onChange={(e)=>handelchanges(e)} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" maxLength={10} placeholder="985654434567" />
      {state.phoneno?state.phoneno.length === 10  ? '' :<small style={{color:'red'}}>Should be 10 Number only</small> :''}
    </div>
  </div>
  ...
  <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
    ...
    <div class="w-full  px-3 mb-6 ">
      ...
      <input value={state.review ? state.review : ''} name='review'  onChange={(e)=>handelchanges(e)} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" placeholder="enter reviews" />
    </div>
  </div>
