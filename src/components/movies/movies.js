    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      ...
      <div class="mx-auto lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
        ...
        <div class="flex justify-center">
          <button class="inline-flex w-60 text-white bg-indigo-800 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Play <span> <i class="fa-solid fa-circle-play ml-6"></i></span></button>
        </div>
      </div>
    </div>
  </section>
