...
useEffect(() => {
 setdata(location.state.data)
  ...
  return (
    <section class="text-gray-600 body-font  bg-indigo-500">
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      ...
      <div class="mx-auto lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
        <h1 class="title-font sm:text-9xl text-7xl mb-4 font-bold text-gray-900">{data.name}
         
        </h1>
        <p class="mb-8 text-gray-800 leading-relaxed">Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
